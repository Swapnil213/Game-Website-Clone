    ...
    return (
      <div className="relative h-dvh w-screen overflow-x-hidden">
        ...
        >
          ...
          <h1 className="uppercase font-zentry font-black text-3xl sm:right-3 sm:text-3xl md:text-4xl lg:text-[5rem] absolute bottom-5 right-5 z-50 text-[#dfdff2]">
            G<b>a</b>ming
          </h1>

          <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10 ">
              <h1 className="uppercase font-zentry font-black text-3xl sm:right-3 sm:text-3xl md:text-4xl lg:text-[5rem] text-[#f0f2fa]">
                redefi<b>n</b>e
              </h1>
        ...
        <h1 className="uppercase font-zentry font-black text-3xl sm:right-3 sm:text-3xl md:text-4xl lg:text-[5rem] absolute bottom-5 right-5 z-40 text-black">
          G<b>a</b>ming
        </h1>
      </div>
    );
